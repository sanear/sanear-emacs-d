...
Based on the Tango color palette."
  ...
  (color-theme-install
   '(color-theme-subdued
     ...
     (default ((t (nil))))
     (font-lock-comment-face ((t (:foreground "#333333")))) ; dark aluminum
     (font-lock-comment-delimiter-face ((t (:foreground "#333333")))) ; dark aluminum
     ...
     (show-paren-match-face ((t (:foreground "green" :background "red"))))
     ...
     (post-multiply-quoted-text-face ((t (:foreground "#666666" :slant normal)))) ; dark aluminum
